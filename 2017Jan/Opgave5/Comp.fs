...
and cExpr (e : expr) (varEnv : varEnv) (funEnv : funEnv) : instr list = 
    ...
    | PrimN (operation, expressions) ->
        ...
        // 32 TUP n s, v1, . . . , vn ⇒ s, p Where n is number of elements and p is pointer to tuple.
        | "upd" -> [UPD]
        //33 UPD s, p, i, v ⇒ s, p Element at index i is updated with value v.
        //The pointer p to the tuple is left on the stack.
        | "nth" -> [NTH]
        // 34 NTH s, p, i ⇒ s, v The value v at index i in the tuple p is left on the stack.
