...
type instr =
  ...
  | PRINTSTAT                          (* Print stack size and ammount of stack frames                      *)
...
let CODEPUSHHDLR  = 41;
let CODEPOPHDLR   = 42
let CODEPRINTSTAT = 43 //Exam 2024
...
let emitints getlab instr ints = 
  ...
  | PRINTSTAT      -> CODEPRINTSTAT :: ints //Exam 2024
...
let ppInst (addr,strs) instr =
  ...
  | PRINTSTAT      -> indent "PRINTSTAT" //Exam 2024
