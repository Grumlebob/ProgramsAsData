...
void mark(word *block)
{
  ...
  for(int i = 1; i < Length(block[0]); i++) { //dont check index 0 as it is the head.
...
void markPhase(word s[], word sp) { //exc.30 should only mark one (xs) as black and the rest should be sweeped
  printf("marking ...\n");
